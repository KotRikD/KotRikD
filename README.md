...
В основном работаю с фронтэндами базированномы на React, хорошо умею работать с Next.JS и прочими фреймворками на JS (vue/nuxt, fastify/koa, svelte, swc/webpack) 
